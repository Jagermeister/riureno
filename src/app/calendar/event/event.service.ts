          ...
          events: [
            {
              ...
              prizes: ['Top 4 Mini Main Event entry'],
            ...
            },
            {
              ...
              notes: ['Starting Chips: 6,000', 'Registration and re-entries through the first six (6) levels', 'No breaks.'],
              speed: 'Turbo',
              type: 'MainEvent',
              time: { hours: 13, minutes: 0 },
              duration: { hours: 4, minutes: 0 },
              buyin: { total: 120, prize: 100 },
              prizes: ['1 Winner per $440 prize pool', 'Winners receive Mini Main Event entry'],
            ...
            },
            {
              key: 3,
              name: 'Welcome Party',
              notes: ['Turkey Burger!', 'Meeting', 'Greeting', 'Eating'],
              type: 'social',
            ...
            },
            {
              ...
              prizes: ['1 raffle ticket for each $25+ RIU store purchase during event', '5 seats to Event #32 - Platinum Pass Invite.'],
              type: 'charity',
          ...
          events: [
            {
              ...
              prizes: ['Winners receive Mini Main Event (Day 1) entry', 'Event #3', '1 in 6 win']
            },
            {
              key: 5,
              identifier: '3',
            ...
            },
            {
              ...
              prizes: ['1 Winner per $600 prize pool', 'Winners receive Main Event entry'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 7,
              format: {
                levelMinutes: 15,
            ...
            },
            {
              ...
              prizes: ['1 Winner per $1,100 prize pool', 'Winners receive Thursday Thrilla entry'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 7,
              format: {
                levelMinutes: 15,
            ...
            },
            {
              ...
              name: 'Hangout',
              type: 'social',
              notes: ['Cash games to be determined'],
          ...
          events: [
            {
              ...
              prizes: ['Winners receive NLH Black Chip Bounty entry', 'Event #7', '2 in 6 win']
            },
            {
              key: 10,
              identifier: '7',
                            ...
                            },*/
            {
              ...
              prizes: ['Funniest costume will win entry to Event #32 - Platinum Pass Invite.'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 9,
              format: {
                levelMinutes: 20
            ...
            },
            {
              ...
              dayTrack: 2,
              notes: ['rake free', 'point value should be low to encourage learning'],
              type: 'social',
              time: { hours: 20, minutes: 0 },
              duration: { hours: 4, minutes: 0 },
              buyin: { isCash: true },
          ...
          events: [
            {
              ...
              duration: { hours: 1, minutes: 30 },
              buyin: { total: 90, prize: 80 },
              prizes: ['Winners receive 6 Max Shootout entry', 'Event #10', '2 in 6 win']
            },
            {
              key: 15,
              identifier: '10',
              ...
              format: {
                levels: [{ levels: 9, minutes: 20 }, { levels: 8, minutes: 15 }],
                breaks: [{ level: 6, minutes: 10 }]
              }
            },
            {
              key: 16,
            ...
            },
            {
              ...
              name: '6 Max Shootout',
              subtitle: 'Round 2',
              notes: ['216 Player Maximum', 'Win your table to advance'],
            ...
            },
            {
              ...
              type: 'social',
              notes: [
                'a circuit of doing gambling-based activities around the peppermill' +
                  '(play an orbit of cash, place a sports bet, play a hand of blackjack, etc).' +
                  ' if you complete everything you get a raffle ticket, and those who get their names drawn get an entry into the plat pass event at the end of the series'
              ],
              prizes: ['3 seats to Event #32 - Platinum Pass Invite'],
              time: { hours: 19, minutes: 0 },
          ...
          events: [
            {
              ...
              prizes: ['Platinum Pass valued at $30k', 'Cash starts at 2nd place'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 10,
              format: {
                levelMinutes: 20,
          ...
          events: [
            {
              ...
              duration: { hours: 1, minutes: 30 },
              buyin: { total: 90, prize: 80 },
              prizes: ['Winners receive 6 MAX 8-Game entry', 'Event #16', '2 in 6 win']
            },
            {
              key: 23,
              identifier: '16',
            ...
            },
            {
              ...
              prizes: ['1 Winner per $1,100 prize pool; 5 GTD'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 7,
              format: {
                levelMinutes: 15,
            ...
            },
            {
              ...
              type: 'social',
              prizes: ['Best solo and/or duet performance will win entry to Event #32 - Platinum Pass Invite.'],
          ...
          events: [
            {
              ...
              prizes: ['Winners receive Thursday Thrilla Bounty entry', 'Event #20', '1 in 6 win']
            },
            {
              key: 29,
              identifier: '20',
            ...
            },
            {
              ...
              notes: ['Hosted by Joe Stapleton and Tyson Apostol', 'Located in Sorrento Ballroom 1'],
              type: 'social',
            ...
            },
            {
              ...
              prizes: ['1 Winner per $600 prize pool; 20 GTD'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 11,
              format: {
                levelMinutes: 15,
          ...
          events: [
            {
              ...
              prizes: ['Winners receive Main Event 1A entry', 'Event #23', '1 in 6 win']
            },
            {
              key: 34,
              identifier: '23',
            ...
            },
            {
              ...
              notes: ['Starting Chips: 6,000', 'Registration and re-entries through first six (6) levels'],
              prizes: ['1 Winner per $600 prize pool'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 7,
              format: {
                levelMinutes: 10
            ...
            },
            {
              ...
              type: 'social',
              notes: ['Your favorite RIU streamers are available for your questions'],
              time: { hours: 18, minutes: 30 },
              duration: { hours: 1, minutes: 30 }
            },
            {
          ...
          events: [
            {
              ...
              duration: { hours: 2, minutes: 0 },
              buyin: { total: 110, prize: 100 },
              prizes: ['Winners receive Main Event 1B entry', 'Event #23', '1 in 6 win']
            },
            {
              key: 41,
              identifier: '23',
            ...
            },
            {
              ...
              prizes: ['1 Winner per $550 prize pool'],
              gameType: "No Limit Hold'em",
              registrationLevelClose: 10,
              format: {
                levelMinutes: 15,
          ...
          events: [
            {
              ...
              prizes: ['Winners receive 6 MAX PLO Championship entry', 'Event #30', '1 in 6 win']
            },
            {
              key: 45,
              identifier: '23',
            ...
            },
            {
              ...
              registrationLevelClose: 10,
              format: {
                levels: [{ levels: 9, minutes: 20 }, { levels: 18, minutes: 30 }],
                breaks: [
                  { level: 6, minutes: 10 },
                  { level: 11, minutes: 10 },
                  { level: 15, minutes: 10 },
          ...
          events: [
            {
              ...
              duration: { hours: 8, minutes: 0 },
              buyin: { isInvitational: true },
              notes: ['Starting Chips: 10,000', 'There is no re-entry available'],
              prizes: ['Platinum Pass valued at $30k'],
              gameType: "No Limit Hold'em",
              format: {
                levelMinutes: 20,
                levelPerBreak: 6,
            ...
            },
            {
              ...
              notes: ['Starting Chips: 10,000', '10 min break at the completion of every six (6) levels'],
              time: { hours: 17, minutes: 0 },
              duration: { hours: 8, minutes: 0 },
              buyin: { total: 125, prize: 100 },
              gameType: 'Taiwanese',
