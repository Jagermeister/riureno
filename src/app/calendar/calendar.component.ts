...
export class CalendarComponent implements OnInit, AfterViewInit {
    ...
    dayOffset: number;
    leftDay: number;
    @ViewChild('dayFrame', { static: false }) divDayFrame: ElementRef;
    ...
    onName(name: string) {
        ...
        this.days.map(d => d.events.map(e => (e.isFiltered = e.name.toLowerCase().indexOf(lowerName) === -1)));
    }
    ...
    computedMaxWidth(): number {
        ...
        const slidePercentage = width > 960 ? 33.33 : width > 640 ? 50 : 100;
